...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col grow items-center justify-center">
      ...
      <div className="w-full px-xl py-m bg-amber-200">Navbar</div>
        ...
        <div className="grid grid-cols-2 px-8">
          <div className="flex flex-col">
            <h1 className="text-56px font-bold">
              The Future of Corporate Governance and FinTech
            </h1>
            <p className="font-medium text-20px text-text-primary">
      ...
      <div className="w-full bg-slate-700">Footer</div>
    </main>
  );
}

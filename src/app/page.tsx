    ...
    <main className="relative flex min-h-screen grow flex-col overflow-x-hidden">
      ...
      <div className="flex flex-1 flex-col w-full">
        ...
        <MotionSection delay={0.3}>
          <div className="flex w-full flex-col items-center justify-center py-16 opacity-40 transition-opacity hover:opacity-100">
            <div className="mb-4 text-[10px] font-bold tracking-[0.3em] text-text-secondary uppercase">The CAFECA Standard</div>
            <div className="flex items-center gap-4 font-serif text-lg italic text-text-secondary md:text-2xl">
              <span>E<sub>intelligent</sub></span>
              <span>=</span>
              ...
              <div className="ml-2 flex flex-col items-center">
                <span className="border-b border-text-secondary/30 px-2 pb-1">Autonomous Decisions</span>
                <span className="pt-1 text-base md:text-lg">Total Transactions × Manual Intervention</span>
              </div>
            </div>
          </div>
        </MotionSection>
